...
import com.bridgelabz.util.UtilSort;
...
public class SortingAlgos 
{
	...
	private static void callAlgos(String[] sTring, int[] iNteger) 
	{
		...
		if(UtilSort.binarySearchString(UtilSort.bubbleSortString(sTring),toFind))
		...
		startTime = System.nanoTime();
		if(UtilSort.binarySearchInt(UtilSort.bubbleSortInt(iNteger),find))
			System.out.println("Found");
		else
			System.out.println("Not Found");
		endTime  = System.nanoTime();
		...
		startTime = System.nanoTime();
		UtilSort.insertionSortString(sTring);
		endTime  = System.nanoTime();
		elapsedTime = (endTime-startTime)*Math.pow(10, -9);
		...
		startTime = System.nanoTime();
		UtilSort.insertionSortInt(iNteger);
		endTime  = System.nanoTime();
		elapsedTime = (endTime-startTime)*Math.pow(10, -9);
		...
		startTime = System.nanoTime();
		UtilSort.bubbleSortString(sTring);
		endTime  = System.nanoTime();
		elapsedTime = (endTime-startTime)*Math.pow(10, -9);
		...
		startTime = System.nanoTime();
		UtilSort.bubbleSortInt(iNteger);
		endTime  = System.nanoTime();
		elapsedTime = (endTime-startTime)*Math.pow(10, -9);
